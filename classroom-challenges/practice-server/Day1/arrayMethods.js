...
//JOIN METHOD
/*
    the join method allows us to concatenate all of the elements in an array. It creates and then returns a string using a separator. NOTE: a separator can be anything!
*/
...
//Split Method
/*
    Splits an element into multiple elements and returns an array. NOTE: It does not chage the original array.
*/
...
//Map Method
/*
    Used to update all the elements in an array on a function that you create.
